...
class Char(size: Int, override var DefaultValue: String) : IDBPlainScaledDataType<String> {
    override var ScaleValue: kotlin.Int = size
    override var Name: String = "CHAR"
    override fun toString(): String = "CHAR($ScaleValue)"
