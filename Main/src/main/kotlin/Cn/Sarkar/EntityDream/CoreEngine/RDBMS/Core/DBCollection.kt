...
//import Cn.Sarkar.EntityDream.CoreEngine.RDBMS.Core.QueryBlocks.Delete.DeleteFrom
//import Cn.Sarkar.EntityDream.CoreEngine.RDBMS.Core.QueryBlocks.Delete.DeleteQueryExpression
//import Cn.Sarkar.EntityDream.CoreEngine.RDBMS.Core.QueryBlocks.Insert.InsertInto
//import Cn.Sarkar.EntityDream.CoreEngine.RDBMS.Core.QueryBlocks.Insert.InsertQueryExpression
//import Cn.Sarkar.EntityDream.CoreEngine.RDBMS.Core.QueryBlocks.Insert.Values
...
//
//open class DBCollection<ITEM : IDBEntity>(var context: IDataContext, val primaryKey: String = IDBEntity.ID, var whereItemCondition: WhereItemCondition = AlwaysSelect(), var itemGenerator: () -> ITEM) : ArrayList<ITEM>(), IDBCollection {
